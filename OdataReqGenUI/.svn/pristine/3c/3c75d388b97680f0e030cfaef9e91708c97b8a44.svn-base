...
public class SplitPanelExample extends CustomComponent {
    ...
    void basic(VerticalLayout layout) {
        ...
        TextField tf = new TextField("Instance");
        hsplit.setFirstComponent(tf);
    ...
    void styling(VerticalLayout layout) {
        ...
        // Put a component in the left panel
        TextField tf3 = new TextField("1234");
        splitpanel.addComponent(tf3);
